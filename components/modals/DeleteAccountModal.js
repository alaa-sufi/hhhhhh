  ...
  return (
   ...
   <div className="text-center">
        ...
        <div className="flex mt-8 justify-between p-1 gap-4">
          <ButtonTheme color="primary" onClick={onDelete} className="w-1/2">{t("dashboard:yes_delete_now")}</ButtonTheme>   
          <ButtonTheme color="primary" outline onClick={onClose}  className="w-1/2">{t("dashboard:no_cancel_the_deletion")}</ButtonTheme>   
        </div>
    </div>
   </Modal.Body>
   <Modal.Footer>
