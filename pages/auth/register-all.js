...
export default function RegisterAll() {
    ...
    return (
        <Login slider noRiskWarning>
            ...
            <DropdownButton open={openIndividual} className="p-3 md:p-5 mb-4 rounded-xl bg-secondary align-center text-xl" center onToggle={() => setopenIndividual(!openIndividual)} head={<div className="grid gap-2 items-center  grid-cols-[1.5rem_8rem] text-help1"> <Profile size="24" color="#333333" />
            ...
            <DropdownButton open={openCompany} className="p-2 md:p-4 mb-4 rounded-xl bg-secondary align-center text-xl" center onToggle={() => setopenCompany(!openCompany)} head={<div className="grid gap-2 items-center  grid-cols-[1.5rem_8rem] text-help1"> <Courthouse size="24" color="#333333" />
            ...
            {/* end company button */}
            {/* start broker button */}
            <DropdownButton className="p-2 md:p-4 mb-4 rounded-xl bg-secondary align-center text-xl" center link="/auth/login-broker" head={<div className="grid gap-2 items-center  grid-cols-[1.5rem_8rem] text-help1"> <UserOctagon size="28" color="#333333" />
