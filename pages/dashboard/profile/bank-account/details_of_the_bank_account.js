  ...
  return (
    <ProfileContainer tab={"bankAccount"}>
      <div className="w-[700px] mx-auto ">
        <h1 className="text-2xl  text-center font-bold mt-8 mb-2">{t("we_need_you_to_fill_the_details_of_your_bank_account")}</h1>
        <span className="text-gray-400 text-center ">{t("do_not_worry_information_that_will_be_safe_with_us_no_one_but_you_will_see_it")}</span>
          ...
          {(props) => {
            ...
            return (
              <form onSubmit={props.handleSubmit}>
                <div className="grid-cols-2 grid gap-x-6 mt-8">
