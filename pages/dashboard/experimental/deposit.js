    ...
    <div className="p-8 bg-white rounded-lg md:rounded-xl">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 mb-8 ">
          ...
          <h1 className="block text-3xl font-bold text-black">{t("deposit")}</h1>
        </div>
        <Link href="/dashboard" >
      ...
      <div className="py-4 mx-auto w-[700px] max-w-full ">
        <div className="mb-4 ">
          <h2 className="mb-4 text-lg text-gray-500">{t("the_deposit_for_calculating")}&nbsp;&nbsp;<span className="text-danger ">({t("experimental_account")})</span></h2>
          <Swiper
