    ...
    <div className="p-8 bg-white dark:bg-dark-white rounded-lg md:rounded-xl">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 mb-8">
          ...
          <h1 className="block text-3xl font-bold text-black dark:text-white ">{t("create_an_demo_account")}</h1>
        </div>
        {currentStep == 0 ?
          <Link href="/dashboard" >
      ...
      <div className="mx-auto py-4 w-[500px] max-w-full">
        {/* start steps numbers*/}
        <div className={`mb-8 flex justify-center items-center text-center gap-12 text-black dark:text-white relative after:top-[calc(50%-1rem)] after:right-[calc(50%_+_1rem)] after:w-[5.5rem] after:transform after:translate-x-1/2 after:-translate-y-1/2  ${currentStep === 0 ? "after:bg-gray-200" : "after:bg-primary"} after:h-1 after:absolute`}>
