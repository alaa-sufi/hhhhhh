    ...
    <div className="p-8 bg-white rounded-lg md:rounded-xl">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 ">
          ...
          <h1 className="font-bold text-black text-3xl">{t("dashboard:deposit")}</h1>
        </div>
        <Link href="/dashboard" >
      ...
      <div className="mx-auto py-4 w-[700px] max-w-full">
        <div className="mb-4">
        <h2 className="text-lg text-gray-500  ">{t("dashboard:the_deposit_for_calculating")}&nbsp;&nbsp;<span className="text-red-500 ">({t("dashboard:experimental_account")})</span></h2>
        </div>
